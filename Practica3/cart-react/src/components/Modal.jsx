  ...
  return (
    <div className="">
      <div class="fondo_transparente">
        <div class="modal">
          <div class="modal_cerrar" onClick={show}>
            <span>x</span>
          </div>
          ...
          <div class="modal_mensaje">
            <p>
              ...
              Suscipit, nam? Minus nihil temporibus, minima reprehenderit, rem
              explicabo earum nemo debitis, maxime deserunt quidem. Quia odit
              quae voluptate nobis sit beatae!
            </p>
          </div>
