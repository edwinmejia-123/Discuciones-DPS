...
this.cargarRegistros();
 ...
 />
 <Text
style={{fontSize:18,textAlign:'center',height:40,marginTop:10,backgroundColor:'lightgray',textAlignVertical:'center',borderRadius:10,marginLeft:10,marginRight:10}}>{this.state.total}
productos</Text>
 <FlatList
...
fetch('https://marketudb.000webhostapp.com/api.php?comando=editar&nombre='+this.state.nombre
...
fetch('https://marketudb.000webhostapp.com/api.php?comando=eliminar&id='+this.state.id, {
 method: 'GET'
 })
 .then((response) => response.json())
 .then((responseJson) => {
